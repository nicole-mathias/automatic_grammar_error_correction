#!/usr/bin/env python3
"""
Render-optimized Grammar Error Detection & Correction Service
Uses ONLY base models to ensure deployment success
"""
...
def load_base_models():
    """Load ONLY base models (no trained weights)"""
    global t5_tokenizer, t5_model, bert_tokenizer, bert_model
    
    logger.info("🚀 Starting Render deployment with base models only...")
...
def detect_errors(text, language='english'):
    """Detect grammar errors in text using base model only"""
...
def correct_grammar(text, language='english'):
    """Correct grammar using base T5 model only"""
...
if __name__ == '__main__':
    logger.info("🚀 Starting Render-optimized Grammar Error Detection & Correction Service")
    load_base_models()
